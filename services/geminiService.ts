...
// Próba pobrania klucza z process.env
const apiKey = process.env.API_KEY || "";

export async function generateEducationalMission(type: Mission['type'], subject?: string): Promise<Mission> {
  // Inicjalizacja instancji przy każdym wywołaniu dla pewności posiadania aktualnego klucza
  ...
  try {
    ...
    return {
      ...
      description: 'AI odpoczywa. Rozwiąż to zadanie: Wymień 5 słów na literę Twojego imienia.',
      rewardMinutes: 10
    };
  }
}
