...
const MissionResultView: React.FC<MissionResultViewProps> = ({ 
  ...
  return (
    <div className="absolute inset-0 bg-gradient-to-b from-[#e0f7fa] via-[#e8f5e9] to-[#f8fafc] z-[200] flex flex-col animate-in zoom-in-95 fade-in duration-500 overflow-y-auto no-scrollbar h-full">
